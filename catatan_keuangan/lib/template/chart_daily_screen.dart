...
class _ChartDailyScreenState extends State<ChartDailyScreen> {
  ...
  void initState() {
    ...
    // var blocCat = context.read<CategoryBloc>();

    // Set<int> selected =
    //     Set.from(blocCat.state.categories.map((e) => e.id).toList());
    // // selected.add
    // setState(() {
    //   data = blocTrans.state.daily;
    // });
  }
