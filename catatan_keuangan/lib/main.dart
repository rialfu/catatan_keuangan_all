...
Future<void> main() async {
  ...
  await FirebaseMsg.instance.initialize();
  // await NotificationSer
    ...
    providers: [
      ...
      BlocProvider<TransactionBloc>(
        create: (_) => TransactionBloc(
          AuthCacheManager(),
          TransactionService(DioManager.instance),
        ),
      ),
      ...
      BlocProvider<SavingPlanBloc>(
        create: (_) => SavingPlanBloc(
          AuthCacheManager(),
          SavingPlanService(DioManager.instance),
        ),
      )
    ],
    child: const MyApp(),
